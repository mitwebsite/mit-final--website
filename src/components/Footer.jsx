...
import logoImg from '../assets/mit-logo-footer.png';
import MapEmbed from './MapEmbed';
import { ArrowUpRight, MapPin, Phone, Printer, PhoneCall, Smartphone } from 'lucide-react';
        ...
        <footer className="footer" id="footer">
            <div className="footer-main">
                ...
                <div className="footer-brand">
                    <Link to="/" className="footer-brand-logo">
                        <img src={logoImg} alt="Malwa Institute of Technology Logo" className="footer-logo-full" />
                    </Link>
                    <p>
                    ...
                    <div className="footer-socials">
                        {[
                            ...
                            {
                                href: 'https://x.com/MalwaInstitute',
                                label: 'X (Twitter)',
                                color: '#ffffff',
                                ...
                                <li key={l.label}>
                                    {l.external ? (
                                        <a href={l.href} target="_blank" rel="noopener noreferrer">
                                            {l.label} <ArrowUpRight size={12} style={{ opacity: 0.5, display: 'inline' }} />
                                        </a>
                                    ) : (
                                        <Link to={l.href}>
                                            {l.label}
                ...
                <div className="footer-col footer-contact">
                    ...
                    <a href="tel:+919522722722" className="footer-contact-item" style={{ textDecoration: 'none', transition: 'color 0.2s', display: 'flex', alignItems: 'center', gap: '0.5rem' }} onMouseOver={(e) => e.currentTarget.style.color = 'var(--crimson)'} onMouseOut={(e) => e.currentTarget.style.color = 'rgba(255, 255, 255, 0.6)'}>
                        <Smartphone size={16} style={{ color: 'rgba(255, 255, 255, 0.4)' }} /> +91 95227 22722
                    </a>
                    <a href="tel:+918109010965" className="footer-contact-item" style={{ textDecoration: 'none', transition: 'color 0.2s', display: 'flex', alignItems: 'center', gap: '0.5rem' }} onMouseOver={(e) => e.currentTarget.style.color = 'var(--crimson)'} onMouseOut={(e) => e.currentTarget.style.color = 'rgba(255, 255, 255, 0.6)'}>
                        <Smartphone size={16} style={{ color: 'rgba(255, 255, 255, 0.4)' }} /> +91 81090 10965
                    </a>
                    <a href="tel:07312810001" className="footer-contact-item" style={{ textDecoration: 'none', transition: 'color 0.2s', display: 'flex', alignItems: 'center', gap: '0.5rem' }} onMouseOver={(e) => e.currentTarget.style.color = 'var(--crimson)'} onMouseOut={(e) => e.currentTarget.style.color = 'rgba(255, 255, 255, 0.6)'}>
                        <PhoneCall size={16} /> 0731-2810001-8
                    </a>
                    <div className="footer-contact-item" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        <Printer size={16} /> 0731-2810005
                    </div>
                </div>
            ...
            <div className="footer-bottom">
                <div className="footer-bottom-inner">
                    <p>© 2026 MIT Indore. All rights reserved | Indus Global Educational & Welfare Society.</p>
