...
const KNOWLEDGE_BASE = [
    {
        ...
        response: "**Fee Structure**\n\nTuition fees at MIT Indore are competitive and follow RGPV/DAVV norms:\n\n- **B.Tech:** Approx. ₹60,000 - ₹75,000 / year\n- **MBA:** Approx. ₹60,000 / year\n- **M.Tech:** Approx. ₹60,000 / year\n- **Diploma:** Approx. ₹30,000 - ₹40,000 / year\n\n*Note: Exact fees may vary based on scholarship programs and specific specializations.*"
    },
    {
        keywords: ["placement", "package", "lpa", "salary", "recruiter", "company"],
        response: "**Placement Records**\n\n- **Highest Package:** ₹18 LPA (Peak Records: ₹36 LPA!)\n- **Students Placed:** 5,000+ students placed to date.\n- **Top Recruiters:** TCS, Cognizant, Zensar, IBM, Persistent, Infogain, Hexaware, Byju's, and Amazon.\n- **Placement Rate:** Typically 80-90% for eligible students in CSE, IT, and AI/ML!"
    },
    {
        keywords: ["admission", "apply", "eligibility", "process", "btech", "mtech"],
        response: "**Admissions 2026-27**\n\nAdmissions are now **OPEN**! We offer B.Tech, MBA, M.Tech, and Diploma courses.\n\n- **Eligibility:** 10+2 with PCM (Min 45% for Gen, 40% for Reserved categories).\n- **Process:** We accept JEE Main, MP BE, GATE, and CMAT scores.\n- **Contact admission cell:** +91-95227-22722."
    },
    {
        keywords: ["contact", "phone", "email", "address", "location", "where"],
        response: "**Contact Information**\n\n- **Location:** Indore-Dewas Bypass Road, Gram Nipaniya, Indore (M.P.) - 452016.\n- **Admission Office:** +91-95227-22722, +91-81090-10965\n- **Email:** admission@mitindore.co.in | info@mitindore.com"
    },
    {
        keywords: ["hod", "department", "head", "cse", "it", "mechanical", "civil", "faculty"],
        response: "**HODs & Departments**\n\n- **CSE & AI/ML:** Mr. Pratyush Sharma\n- **Information Technology:** Ms. Rajni Chaturvedi\n- **Electronics (ECE):** Ms. Deepika Sharma\n- **Electrical (EX):** Mr. Pawan Pandey\n- **Mechanical (ME):** Mr. Abhilash Soni\n- **Automobile (AU):** Mr. Dheeraj Mandliya\n- **Civil (CE):** Mr. Satyendra Tiwari\n- **MBA:** Dr. Kranti Pandey\n- **Applied Sciences:** Dr. Garima Dubey"
    },
    {
        keywords: ["founder", "director", "chairman", "principal", "management", "leader"],
        response: "**Leadership & Management**\n\n- **Founder Chairman:** Late Shri Kailash Chandra Jolly\n- **Chairman & MD:** Shri R.S. Jolly\n- **Vice-Chairman:** Shri Puneet Jolly\n- **Principal:** Dr. Sharad Jain\n- **T&P Head:** Mr. Irfan Ahmed"
    },
    {
        keywords: ["hi", "hello", "hey", "start"],
        response: "Hello! Welcome to **MIT Indore**.\n\nI can help you with admissions, HOD details, fee structures, placement records, and contact information. What would you like to know?"
    }
];
...
const GREETING_RESPONSE = KNOWLEDGE_BASE[6].response;

const QUICK_ACTIONS = [
    { label: 'Admissions', icon: GraduationCap, key: 'admission' },
    { label: 'HODs', icon: User, key: 'hod' },
...
const mdComponents = {
    p: ({ children }) => <p style={{ marginBottom: '0.5rem', lineHeight: 1.6, fontSize: '14px' }}>{children}</p>,
    strong: ({ children }) => <span style={{ fontWeight: 600, color: '#0f172a' }}>{children}</span>,
    ul: ({ children }) => <ul style={{ marginTop: '0.5rem', marginBottom: '0.5rem', paddingLeft: '1rem', listStyleType: 'disc' }}>{children}</ul>,
    li: ({ children }) => <li style={{ fontSize: '13.5px', paddingLeft: '2px', lineHeight: 1.6 }}>{children}</li>,
    a: ({ href, children }) => <a href={href} style={{ color: '#b91c1c', textDecoration: 'underline', fontWeight: 500 }}>{children}</a>,
};
...
const Chatbot = () => {
    ...
    const sendMessage = (text) => {
        ...
        setTyping(true);
        setTimeout(() => {
            const botMsg = { id: Date.now() + 1, role: 'bot', text: getBotReply(text), time: getTime() };
            setTyping(false);
