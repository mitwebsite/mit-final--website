...
import { Target, MessageSquare, Briefcase, Handshake, Calendar, MapPin, Trophy, Star } from 'lucide-react';
...
function useCountUp(target, duration = 2000, active = false, decimal = false) {
            ...
            <section className="pl-hero" style={{ position: 'relative' }}>
                ...
                <div className="pl-hero-content">
                    ...
                    <div className="pl-hero-badges">
                        <span className="pl-badge"><Trophy size={14} /> Proven Track Record</span>
                        <span className="pl-badge"><Briefcase size={14} /> ₹18 LPA Highest</span>
                        <span className="pl-badge"><Star size={14} /> Industry Partnerships</span>
                        <span className="pl-badge"><Star size={14} /> Career Launchpad</span>
                        <span className="pl-badge"><Star size={14} /> High Success Rate</span>
                    </div>
                </div>
                            ...
                            <div className="pl-features-grid">
                                {features.map((f, i) => (
                                    <div className="pl-feature-card" key={i} style={{ animationDelay: `${i * 0.12}s` }}>
                                        <div className="pl-feature-icon" style={{ color: 'var(--crimson)' }}>{f.icon}</div>
                                        <div>
                            ...
                            <div className="pl-tp-card-stack">
                                ...
                                <div className="pl-tp-info-row">
                                    <div className="pl-tp-info-pill">
                                        <Calendar size={14} /> Active since 2004
                                    </div>
                                    <div className="pl-tp-info-pill">
                                        <MapPin size={14} /> Pan-India Drives
                                    </div>
                                </div>
